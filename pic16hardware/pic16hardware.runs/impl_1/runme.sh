...
HD_PWD='C:/mueller/SOCL3/pic16hardware/pic16hardware.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log zedpi_sys_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source zedpi_sys_wrapper.tcl -notrace
