...
HD_PWD='C:/mueller/SOCL3/pic16hardware/pic16hardware.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zedpi_sys_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zedpi_sys_wrapper.tcl
