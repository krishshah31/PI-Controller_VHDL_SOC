...
HD_PWD='c:/mueller/socl3/pic16hardware/ip_repo/edit_pictrlip_v1_0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pictrlip_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pictrlip_v1_0.tcl
