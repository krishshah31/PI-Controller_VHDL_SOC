...
--Command     : generate_target zedpi_sys_wrapper.bd
--Design      : zedpi_sys_wrapper
...
end zedpi_sys_wrapper;

architecture STRUCTURE of zedpi_sys_wrapper is
  component zedpi_sys is
  port (
    zSwitch : in STD_LOGIC_VECTOR ( 7 downto 0 );
    zPushB : in STD_LOGIC_VECTOR ( 4 downto 0 );
    zLED : out STD_LOGIC_VECTOR ( 7 downto 0 );
  ...
  end component zedpi_sys;
begin
zedpi_sys_i: component zedpi_sys
     port map (
