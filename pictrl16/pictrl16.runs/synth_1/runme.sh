...
HD_PWD='C:/mueller/SOCL3/pictrl16/pictrl16.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pictrl16.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pictrl16.tcl
