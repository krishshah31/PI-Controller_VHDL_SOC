...
HD_PWD='C:/mueller/SOCL3/pictrlzync/pictrlzync.runs/zedb_sys_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zedb_sys_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zedb_sys_processing_system7_0_0.tcl
