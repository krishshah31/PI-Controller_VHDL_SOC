...
HD_PWD='C:/mueller/SOCL3/pictrlzync/pictrlzync.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log zedb_sys_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source zedb_sys_wrapper.tcl -notrace
