...
HD_PWD='C:/mueller/SOCL3/pictrlzync/pictrlzync.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zedb_sys_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zedb_sys_wrapper.tcl
